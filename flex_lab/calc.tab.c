...
{
  "\"end of file\"", "error", "\"invalid token\"", "FLOAT_LIT", "'+'",
  "'-'", "'*'", "'/'", "'('", "')'", "$accept", "root", "term", "factor",
  "primary", YY_NULLPTR
};
...
#line 30 "calc.y"
                                {
    (yyval.fltval) = (yyvsp[-2].fltval) + (yyvsp[0].fltval);
}
...
#line 1379 "calc.tab.c"
  ...
  case 10: /* primary: '(' term ')'  */
#line 43 "calc.y"
                                  {
    (yyval.fltval) = (yyvsp[-1].fltval)
}
